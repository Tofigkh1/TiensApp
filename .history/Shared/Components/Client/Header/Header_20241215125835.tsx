...
import TiensBackground1 from '../../../../public/TiensBackground1.jpg';
  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <SwiperSlide>
        <div
style={{ height: '480px', width: '710px',  WebkitBorderRadius: '120px'}}></div>
          <Image
           style={ { transform: 'scale(1)', objectPosition: 'bottom', borderRadius: '100px' }} 
         
           objectFit="cover" 
          src={TiensBackground1} alt="Image 1" layout="fill" />
        </SwiperSlide>
        <SwiperSlide>
          <Image src={TiensBackground2} alt="Image 1" layout="fill" objectFit="cover" />
        </SwiperSlide>
        <SwiperSlide>
          <Image src={DoctorImg2} alt="Image 1" layout="fill" objectFit="cover" />
        </SwiperSlide>
