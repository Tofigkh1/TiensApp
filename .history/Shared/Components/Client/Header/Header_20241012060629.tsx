...
export default function Header() {
  ...
  return (
    <div className={styles.container}>
      ...
      >
     <SwiperSlide style={{ height: isMobile ? '600px' : '400px', position: 'relative' }}>
  <div style={{ height: '100%', width: '100%', position: 'relative' }}>
    <Image 
      ...
      style={{ transform: 'scale(1.1)', objectPosition: 'bottom' }} // Görseli büyütmek ve alt kısımdan zoom yapmak için
    />
  </div>
</SwiperSlide>
        {/* <SwiperSlide>
