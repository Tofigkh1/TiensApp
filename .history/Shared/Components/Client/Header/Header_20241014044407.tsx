...
export default function Header() {
  ...
  // Sayfa tamamen yüklendiğinde ve boyutlandırıldığında container'ı görünür yap
  useEffect(() => {
    const handleLoad = () => {
      document.querySelector(`.${styles.container}`)?.classList.add('loaded');
      // Sayfa yüklendiğinde boyutlandırmayı yeniden tetikle
