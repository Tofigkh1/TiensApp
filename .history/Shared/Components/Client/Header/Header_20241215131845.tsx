...
import TiensBackground1 from '../../../../public/TiensBackground1 (1).jpg';
...
export default function Header() {
  ...
  <div
    style={{
      height: '100vh',
      width: '100vw',
      overflow: 'hidden', // Görüntü taşmasını önlemek için
    }}
  >
    <Image
      objectFit="cover" // Görselin taşmadan tüm ekranı kaplamasını sağlar
      layout="fill" // Ekranın tamamına yayılmasını sağlar
