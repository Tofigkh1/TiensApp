            ...
            <div className={style.oneOfferDiv}>
                ...
                <div className='' >
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        <div className={style.excludeText}>
                            <Image src={Exclude} alt="Icon" width={18} height={0} />
                            <h1 className='pt-5 font-semibold'>Pisxoloji gərginliklərdən qurtulmanın yolları</h1>
                        </div>
                        <div className={style.excludeText}>
                            <Image src={Exclude} alt="Icon" width={18} height={0} />
                            <h1 className='pt-2 font-semibold'>Bütün suallarının cavabı hər zaman bizdə</h1>
                        </div>
                        <button
