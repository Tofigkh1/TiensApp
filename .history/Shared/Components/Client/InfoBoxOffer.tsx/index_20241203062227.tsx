                ...
                <div className={style.oneTitle}>
                    ...
                    <div className={style.excludeAllText}>
                        <div className={style.excludeText}>
                            ...
                            <h1 className=' font-semibold'>ilk alış-verişdə 4 və ya daha artiq müxtəlif məhsul al</h1>
                        </div>
                        <div className={style.excludeText}>
                            <Image src={Exclude} alt="Icon" width={18} height={0} />
                            <h1 className=' font-semibold'> sonrakı alış-veriş 20% ilk alış-verişdə 3 müxtəlif məhsul al sonrakı alış-veriş 10%</h1>
                        </div>
                        <div className={style.excludeText}>
                            <Image src={Exclude} alt="Icon" width={18} height={0} />
