                    ...
                    <div className='' >
                        <div className=' mr-10'>
                            ...
                            <div className={style.excludeAllText}>
                                ...
                                <button
                                    onClick={() => push('/medicines')}
                                    className="bg-white text- border border-clientButtonGreen ml rounded-[50px] px-4 py-2 flex items-center gap-5 justify-center w-60 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white"
