...
function InfoBoxOffer(props: Props) {
    ...
    {/* Resim ve metin bölümleri */}
    <div className={`${style.imageContainer}`} data-aos={mobile ? 'fade-up' : 'fade-left'}>
        <Image className={style.oneImage} src={MedicinesIcon} alt="Icon" width={511} height={0} />
    </div>

    <div className={`${style.textContainer}`} data-aos={mobile ? 'fade-up' : 'fade-right'}>
