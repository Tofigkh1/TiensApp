            ...
            <div className={style.oneOfferDiv}>
                ...
                <div className={`${style.textContainer}`} data-aos='fade-up'>
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        className={`bg-white bg border border-clientButtonGreen rounded-full px-4 py-2 flex items-center gap-5 justify-center w-60 h-12 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white`}
