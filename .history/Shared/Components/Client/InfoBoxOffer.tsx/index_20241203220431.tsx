...
{mobile ? (
            <div className=' mt-24 justify-around'>
                ...
                <div className='' >
                <Image className=' absolute mt-1 ml-14' alt='globallogo'  src={GlobeLogo} width={300} height={300}/>
                    <Image className={style.oneImage} src={GroupLayoutt} alt="Icon" width={411} height={0} />
...
<div className=' mt-24 justify-around'>
            ...
            <div className={style.oneOfferDiv}>
                ...
                <div className='' >
                    <div className={style.oneTitle}>
                        <h1>Sosial həyatda hər zaman</h1>
                        <h1>çətinliklərin öhdəsindən gəl</h1>
                    </div>
            ...
            <div className={style.oneOfferDiv}>
                ...
                <div className={style.oneTitle}>
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        <button
  onClick={() => push('/contact-us')}
  className="bg-white text- border border-clientButtonGreen rounded-[50px] ml-3 px-4 py-2 flex items-center gap-5 justify-center w-60 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white"
