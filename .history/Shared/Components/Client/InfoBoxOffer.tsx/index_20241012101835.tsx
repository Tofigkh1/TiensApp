            ...
            <div className={style.oneOfferDiv}>
                ...
                <div className={`${style.textContainer}`} data-aos='fade-up'>
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        className={`bg-white border border-clientButtonGreen rounded-xl px-4 py-2 flex items-center gap-5 justify-center w-60 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white`}
