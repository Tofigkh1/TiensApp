                ...
                <div className={style.oneTitle}>
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        <button
                            ...
                            className={`bg-white bg- border border-clientButtonGreen rounded-full ml-20 px-4 py-2 flex items-center gap-5 justify-center w-60 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white`}
