...
<div className='' >
                   <div className=' absolute mt-36 ml-28'>
                    <Swiper
  effect={'cards'}
  grabCursor={true}
  modules={[EffectCards]}
...
<div className=' pt-2'>
    <h1 className=' font-bold text-5xl'>
        30%
                    ...
                    <Image className={style.oneImage} src={GroupLayout} alt="Icon" width={350} height={0} />
...
<div className=' pt-2'>
    <h1 className=' font-bold text-5xl'>
        30%
                    ...
                    <Image className={style.oneImage} src={GroupLayout} alt="Icon" width={450} height={0} />
