                ...
                <div className='' data-aos='fade-up'>
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        <button
                            ...
                            className="bg-white text- border border-clientButtonGreen rounded-[50px]  py-2 flex items-center gap-5 justify-center w-60 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white"
                        >
                            Get prescription
                            <Image src={buttonVector} alt="Icon" width={17} height={0} />
                        </button>
