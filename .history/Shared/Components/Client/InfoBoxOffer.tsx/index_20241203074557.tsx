            ...
            <div className={style.oneOfferDiv}>
                ...
                <div className='' >
                    ...
                    <div className={style.excludeAllText}>
                        ...
                        <div className={style.excludeText}>
                            <Image src={Exclude} alt="Icon" width={18} height={0} />
                            <h1>Pisxoloji gərginliklərdən qurtulmanən yolları</h1>
                        </div>
                        <div className={style.excludeText}>
                            <Image src={Exclude} alt="Icon" width={18} height={0} />
                            <h1>Uğurlu gələcək üçün zehinini gücləndir</h1>
                        </div>
                        <button
  onClick={() => push('/contact-us')}
  className="bg-white text- border border-clientButtonGreen rounded-[50px] pl-9 px-4 py-2 flex items-center gap-5 justify-center w-60 transition-all duration-300 hover:bg-clientButtonGreen hover:text-white"
