...
<div className="mt-96">
<Swiper
  slidesPerView={2} // Yan yana 2 slayt gösterilir (daha dar görünüm için)
  ...
  className="mySwiper"
  style={{
    width: "100vh", // Ekranın tamamını kapsar
    height: "100px", // Yükseklik artırıldı
  }}
>
  {mediaList.map((media, index) => (
    <SwiperSlide
      ...
      style={{
        ...
        justifyContent: "center",
        alignItems: "center",
        height: "360px", // Her slaytın yüksekliği uzatıldı
        borderRadius: "8px",
        overflow: "hidden",
      }}
    >
      ...
      {media.covers.length > 0 ? (
        <Image
          ...
          alt="Cover"
          layout="responsive"
          width={9} // Görüntü oranı (9:16 dikey)
          height={16}
          priority
          style={{
            objectFit: "cover",
            borderRadius: "8px", // Köşeler yuvarlatıldı
          }}
        />
      ) : (
        <div
