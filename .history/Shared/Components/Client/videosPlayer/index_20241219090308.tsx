...
<Swiper
  ...
  style={{
    width: "1360px",
    height: "150px", // Swiper yüksekliği kısaltıldı
  }}
>
  {mediaList.map((media, index) => (
    <SwiperSlide
      ...
      style={{
        ...
        justifyContent: "center",
        alignItems: "center",
        height: "150px", // Görsel alanının yüksekliği kısaltıldı
        borderRadius: "8px",
        overflow: "hidden",
      }}
    >
      ...
      {media.covers.length > 0 ? (
        <Image
          ...
          alt="Cover"
          layout="responsive"
          width={21} // Görüntü oranı (21:9 geniş ekran)
          height={9}
          priority
          style={{
            objectFit: "cover",
        ...
        <div
          style={{
            width: "100%",
            height: "130px", // Alternatif kapak için yükseklik
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            backgroundColor: "#ccc",
