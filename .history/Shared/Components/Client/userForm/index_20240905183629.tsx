                ...
                <Form>
                    <div className={div}>
                        <div className={inpdiv}>
                            <Input value={user.phoneNumber} name='phone' type='text' placeholder={user.phoneNumber ? user.phoneNumber : '+994 XX XXX XX XX'} title="Contact Number" />
                            <Input value={user.username} name='username' type='text' placeholder={user.username} title="User Name" />
                            <Input value={user.fullname} name='fullname' type='text' placeholder={user.fullname} title="Full Name" />
                        </div>
                        <div className={inpdiv}>
                            <Input name='email' type='email' title='Email' value={user.email} />
                            <Input value={user.address} name='address' type='text' placeholder={user.address} title="Address" />
