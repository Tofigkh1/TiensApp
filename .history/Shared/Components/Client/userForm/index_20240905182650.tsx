...
const UserForm: React.FC<Props> = (props: Props) => {
    ...
    // Redux'tan gelen kullanıcı bilgilerini al ve formu bu bilgilere göre güncelle
    useEffect(() => {
    ...
    // Redux'taki user bilgilerini dinamik olarak initialValues içine koy
                ...
                <Form>
                    <div className={div}>
                        <div className={inpdiv}>
                            ...
                            <Input name='username' type='text' placeholder='Username' title="User Name" />
