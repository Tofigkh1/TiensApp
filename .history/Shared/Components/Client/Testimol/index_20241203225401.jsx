...
const testimonials = [
  ...
  {
    text: "Əla xidmət, gülərüz personal və sürətli çatdırılma. Daha çox xahiş edə bilməzdim!",
    author: "Zakir Əliyev",
  },
  {
    text: "Dərmanlar həqiqətən təsirlidir, buna görə Rövşən həkimə təşəkkür edirəm.",
    author: "Sadiq Qəribov",
  },
];
...
function Testimonial() {
  ...
  return (
    ...
    Müştərilərimizin rəyləri
      ...
      <Stack direction="row" justify="center" mt={2} ml={indicatorMargin}>
