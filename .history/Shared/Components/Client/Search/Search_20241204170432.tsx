...
export default function Search() {
    ...
    const handleSearchClick = () => {
        ...
        if (matchedProduct) {
            ...
            updatedHistory = [
                { name: matchedProduct.name ?? '', id: matchedProduct.id ?? '' }, // Varsayılan değer ekleniyor
    ...
    const handleHistorySelect = (historyItem: { name: string; id: string }) => {
        ...
        setSelectedProduct(
            matchedProduct ?? {
                ...
                cover_url: '', // Varsayılan bir değer
                created: new Date().toISOString(), // Varsayılan bir tarih
                category_id: '0', // Varsayılan bir kategori
                allDescription: '', // Varsayılan bir açıklama
            }
        );
