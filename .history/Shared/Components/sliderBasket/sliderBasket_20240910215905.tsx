...
const BasketMenu = () => {
  ...
  <div className=' flex justify-around'>
          ...
          <div key={index}  className="w-56  h-auto  rounded-2xl border border-whiteLight3 bg-white flex">
             
                  <div spaceBetween={50} slidesPerView={1} className="mySwiper cursor-pointer">
     
        
                <Image key={index} src={items.img_url} alt={`Product Image ${index + 1}`} width={150} height={120} />
