...
const BasketMenu = () => {
  ...
  <div className=' flex justify-around'>
          ...
          <div key={index}  className="w-56 h-32 h-auto  rounded-2xl border border-whiteLight3 bg-white flex">
                ...
                <div className=' right-0  bg-clientButtonGreen rounded-xl w-20 h-16 text-center'>
                  <div className='ml-3 flex gap-2 mt-4 font-semibold text-xl'>
