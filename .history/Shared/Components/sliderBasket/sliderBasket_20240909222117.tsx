...
const BasketMenu = () => {
  ...
  return (
   ...
   <div key={index}  className="w-36 h-36 h-auto m-4 rounded-2xl border border-whiteLight3 bg-white">
                ...
                <Image key={index} src={items.imageUrl} alt={`Product Image ${index + 1}`} width={120} height={120} />
