...
<div className=' right-0'>
              {basketDiscount > 0 && (
    <div className=' flex apg '>
      <h1 className='text-xl font-semibold text-black'>Endirimli qiymət:</h1> 
      <h1 className='text-xl font-semibold text-black'>{basketDiscount}₼</h1>
    </div>
  )}        
                </div>
  </div>
