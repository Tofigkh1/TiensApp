...
<div className='flex justify-end gap-32 mt-5 mr-6'>
  ...
  <div>
    <h1 className='text-xl font-semibold'>{basketAmount}</h1>
  </div>
  
</div>

<div className='flex justify-end mr- mt-4'>
<button className=' bg-clientButtonGreen w-64 h-12 rounded-lg '>Checkout</button>
</div>
