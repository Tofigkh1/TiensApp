    ...
    <div>
      <h1
        className={`text-2xl font-semibold ${
          basketDiscount > 0 ? "text-gray-400" : "text-black"
        }`}
      >
        Cəmi məbləğ:
      </h1>
  ...
  <div className="right-0">
    {basketDiscount > 0 && (
      <div className="flex gap-3">
        <h1 className="text-2xl font-semibold text-red-600">Endirimli qiymət:</h1>
        <h1 className="text-2xl font-semibold text-red-600">{basketDiscount}₼</h1>
      </div>
    )}
  </div>
</div>
...
<button  className=' flex ' onClick={() => handleDeleteAllBasket(basketId)}>
  ...
  <div className="right-0">
    {basketDiscount > 0 && (
      <div className="flex gap-3">
        <h1 className="text-xl font-semibold text-red-600">Endirimli qiymət:</h1>
        <h1 className="text-xl font-semibold text-red-600">{basketDiscount}₼</h1>
      </div>
    )}
  </div>
</div>
