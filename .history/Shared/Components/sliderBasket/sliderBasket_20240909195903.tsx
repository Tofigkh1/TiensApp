...
import { useRouter } from 'next/router'; // useRouter import ediliyor
...
const BasketMenu = () => {
  ...
  const router = useRouter(); // useRouter hook'u ekleniyor
  ...
  useEffect(() => {
    ...
    // URL değiştiğinde tetiklenmesi için event listener ekleniyor
    router.events.on('routeChangeComplete', handleRouteChange);

    return () => {
      // Bileşen unmount olduğunda event listener kaldırılıyor
