...
const BasketMenu = () => {
  ...
  <div className='flex flex-col justify-around'>
          ...
          <div key={index}  className=" flex w-36  h-auto  rounded-2xl border border-whiteLight3 bg-white flex">
             
                  <div className="">
     
        
                <Image key={index} src={items.img_url} alt={`Product Image ${index + 1}`} width={150} height={150} />
                ...
                <h1 className=' font-bold text-xl mr-20' key={index} >{items.name}</h1>

                
                <div className=' right-0  bg-clientButtonGreen rounded-xl w-20 h-auto  text-center'>
