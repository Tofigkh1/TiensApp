...
const BasketMenu = () => {
  ...
  <div key={index} className='flex flex-col justify-around'>
    <div className="w-36 h-auto rounded-2xl border border-whiteLight3 bg-white flex">
      <div>
        <Image src={items.img_url} alt={`Product Image ${index + 1}`} width={150} height={150} />
      </div>
    </div>
    <h1 className='font-bold text-xl mr-20'>{items.name}</h1>
    ...
    {/* Yatay çizgiyi buraya ekleyebilirsin */}
