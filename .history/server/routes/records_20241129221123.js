...
export async function handlerAddRecordPOST(req, res, col) {
  ...
  try {
    ...
    // Retrieve the user's basket data
    ...
    // Check for existing records and discount eligibility
    ...
    // Generate discount code if conditions are met
    ...
    // Calculate expiry date (16 days later)
    ...
    // Clear the basket (both items and count)
    await uptData("basket", basket_id, { items: [], count: 0 });
