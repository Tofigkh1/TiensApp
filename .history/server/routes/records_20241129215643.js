...
export async function handlerAddRecordPOST(req, res, col) {
  ...
  try {
    ...
    // Kullanıcının sepet verilerini alın
    ...
    // Mevcut kayıtları ve noDiscount durumunu kontrol et
    ...
    if (userBasket.items.length >= 4 && !existingRecord.length && !hasExistingDiscount) {
      ...
      // "noDiscount" koleksiyonuna ekle veya güncelle
    ...
    // 16 gün sonrası için son kullanım tarihi
