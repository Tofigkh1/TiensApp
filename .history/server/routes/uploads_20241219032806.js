...
export async function handlerGetAllVideos(req, res, folder) {
  try {
    ...
    // Videoları al
    const videoFolderRef = ref(storage, "uploads/videos/044365e3-fe55-4fda-b082-9fc82d74071b");
    ...
    const coverFolderRef = ref(storage, "uploads/covers/044365e3-fe55-4fda-b082-9fc82d74071b");
