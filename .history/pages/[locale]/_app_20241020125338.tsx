...
import { appWithTranslation } from 'next-i18next'; // i18n ekleniyor
import '../lib/i18n'; // i18n yapılandırmasını import et
...
export default wrapper.withRedux(appWithTranslation(MyApp)); // i18n ile sarmalıyoruz
