...
console.log("user",user);
  ...
  useEffect(() => {
    ...
    // Eğer basketDiscount uzunluğu 0'dan büyükse görünür yap
    ...
    // 2 dakika sonra animasyonu durdur
    const stopAnimationTimer = setTimeout(() => {
      setIsAnimating(false);
    }, 120000); // 2 dakika = 120000 ms

    return () => clearTimeout(stopAnimationTimer); // Temizleme
  }, []);
   ...
   <div>
     <Container>
        <Header>
          ...
          <div className={`mt-96 fixed  z-50 ${isAnimating ? 'animate' : ''}`}>
      <Image alt="animationgif" src={GiftCard} width={180} height={180} />
    </div>
          <Nav />
