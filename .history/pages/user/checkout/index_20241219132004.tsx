...
import GiftCard from "../../../public/Loyalty Program 3D Animated Icon (1).gif";
...
import Sidebar, {
  SidebarItem,
} from "../../../Shared/Components/Client/SideBarMenu";
import { AppDispatch, RootState } from "../../../Shared/Redux/Store/store";
import {
  clearUser,
  setUser,
  UserState,
} from "../../../Shared/Redux/Featuries/User/userSlice";
...
import {
  ...
  deleteFromBasket,
  fetchBasket,
} from "../../../Shared/Redux/Featuries/basketSlice/basketSlice";
...
import {
  ...
  fetchRecords,
  RecordsPostDataType,
} from "../../../Shared/Redux/Featuries/recordSlice/recordSlice";
...
export default function index() {
  ...
  const basketDiscount = basket?.data?.discount_total ?? 0;
  ...
  //  if ( basketDiscount?.length > 0) {
  //       setIsVisible(true);

  //       // 2 dakika sonra gizle
  ...
  const { isRectVisible, isRectVisible2 } = useSelector(
    (state: RootState) => state.buttonVisibility
  );
  ...
  const handleChange = (e: any) => {
    ...
    if (!addressRegex.test(value)) {
      ...
      dispatch({
        type: "SET_FORMAT_MESSAGE",
        payload: "Örnək format: Ataturk Ganclik Baku 45",
      });
    } else {
  ...
  const handleChange1 = (event: any) => {
    ...
    if (
      formattedValue === "+994" ||
      formattedValue === "+994-" ||
      azerbaijanPhoneRegex.test(formattedValue)
    ) {
      ...
      dispatch({
        ...
        payload: "Azerbaycan nömresi girməlisiz!",
      });
      dispatch({
        type: "SET_FORMAT_NUMBER",
        payload: "Örnək: +994-55-555-55-55",
      });
    }
  };
        ...
        <div>
          <Container>
            <Header>
              ...
              <div className=" cursor-pointer" onClick={handleClickk}>
                {basketDiscount > 0 && (
                  <div
                    className={`mt-96 fixed left-0 z-50 ${
                      isAnimating ? "animate" : ""
                    }`}
                  >
                    <Image
          ...
          <div className="flex gap-11 justify-between">
            <Sidebar>
              ...
              <SidebarItem
                icon={
                  <img src="/exit.png" alt="Logout" width={39} height={39} />
                }
                text="Logout"
            ...
            {basketItems.length > 0 ? (
              ...
              <div>
                ...
                <h1 className="text-center font-bold text-6xl  mt-6 text-categorycolor">
                  Səbət Boşdur!
                </h1>
              </div>
            )}
          ...
          <div className="flex gap-11 justify-between">
            {basketItems.length > 0 ? (
              ...
              <div>
                ...
                <h1 className="text-center font-bold text-5xl ml-14 mt-6 text-categorycolor">
                  Səbət Boşdur!
                </h1>
              </div>
            )}
