...
console.log("user",user);
  ...
  const basketDiscount = parseFloat(basket?.data?.discount_total?.toFixed(2) ?? '0');
...
// };
   ...
   <div>
    ...
    {basketDiscount > 0 && (
      <div className={`mt-96 fixed left-0 z-50 ${isAnimating ? 'animate' : ''}`}>
      <Image alt="animationgif" src={GiftCard} width={130} height={130} />
    </div>
  )}
    </div>
