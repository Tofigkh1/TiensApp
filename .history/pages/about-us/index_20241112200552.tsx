...
<Swiper
      ...
      >
         <SwiperSlide style={{ height: isMobile ? '600px' : '500px', position: 'relative' }}></SwiperSlide>
<div
style={{ height: '385px', width: '650px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-8">


<div style={{ height: '370px', width: '570px',  marginLeft: '8px', }}>
