...
<div
style={{ height: '500px', width: '650px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-5">


<div style={{ height: '440px', width: '570px',  marginLeft: '8px', }}>
...
<div style={{ height: '440px', width: '570px',  marginLeft: '8px', }}>
 ...
 />
        ...
        <SwiperSlide>
        <div
style={{ height: '530px', width: '650px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-5">


<div style={{ height: '470px', width: '570px',  marginLeft: '8px', }}>
