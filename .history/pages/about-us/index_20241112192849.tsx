...
import DoctorAbouImg from '../../public/doctorAbouImg.png'
...
<div>
 <Image               layout="fill"  
              objectFit="cover"  
              style={isMobile ? { transform: 'scale(1.1)', objectPosition: 'bottom' } : {}} alt="doctorAbout" width={100} height={100} src={DoctorAbouImg}/>
</div>
