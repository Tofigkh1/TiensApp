...
<p
style={{ height: '480px', width: '690px',}}
...
<div style={{ height: '420px', width: '630px',  marginLeft: '9px', }}>
 ...
 />
        ...
        <div
style={{ height: '480px', width: '710px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-16">


<div style={{ height: '310px', width: '470px',  marginLeft: '30px', }}>
 <Image alt="doctorAbout"  src={DoctorImg}
              style={ { transform: 'scale(1.5)', objectPosition: 'bottom', borderRadius: '100px' }} 
