...
import DoctorImg from '../../public/Doctorphoto.jpg'
...
<div className=" mt-20  p-9 ">
  <h1 className=" font-bold text-3xl ml-24">DOKTOR TIBET</h1>
<p
...
<div
style={{ height: '480px', width: '710px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-5">


<div style={{ height: '420px', width: '630px',  marginLeft: '9px', }}>
...
<div style={{ height: '420px', width: '630px',  marginLeft: '9px', }}>
 <Image alt="doctorAbout"  src={DoctorImg2}
              style={ { transform: 'scale(1.1)', objectPosition: 'bottom', borderRadius: '100px' }} 
...
<div style={{ height: '420px', width: '630px',  marginLeft: '9px', }}>
 <Image alt="doctorAbout"  src={DoctorCollcet}
              style={ { transform: 'scale(1.1)', objectPosition: 'bottom', borderRadius: '100px' }} 
...
<div className=" mt-20  p-9 ">
  <h1 className=" font-bold text-3xl ">DOKTOR TIBET</h1>
<p
style={{ height: '480px', width: '700px',}}
className=" mt-10 text-2xl">
...
<Swiper
        ...
        modules={[Autoplay, Pagination, Navigation]}
        onAutoplayTimeLeft={onAutoplayTimeLeft}
        className={`${styles.swiper1} ${styles.background}`}
      >
         <SwiperSlide style={{ height: isMobile ? '570px' : '570px', position: 'relative' }}>
<div
style={{ height: '280px', width: '310px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-5">
...
<div style={{ height: '420px', width: '630px',  marginLeft: '9px', }}>
 ...
 />
        ...
        <SwiperSlide>
        <div
style={{ height: '480px', width: '310px',  WebkitBorderRadius: '120px'}}
className=" bg-emerald-300  mt-12 p-5">
