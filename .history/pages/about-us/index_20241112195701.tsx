...
<div
style={{ height: '390px', width: '670px',  WebkitBorderRadius: '120px', marginTop: '35px'}}
className=" bg-emerald-300  mt-12 p-8">


<div style={{ height: '370px', width: '570px',  marginLeft: '55px', marginTop: '20px'}}>
 <Image alt="doctorAbout"  src={DoctorAbouImg}
              style={ { transform: 'scale(1.1)', objectPosition: 'bottom', borderRadius: '90px' }} 
