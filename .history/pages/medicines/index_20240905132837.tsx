    ...
    <div>
      ...
      {hoveredCategory && (
        <MotionVStack
          ...
          onMouseEnter={handleMouseEnter}  // Fare açılan ürünlerin üzerine gelince kapanmaması için
          onMouseLeave={handleMouseLeave}  // Fare hem kategori hem ürünlerin üzerinden ayrılınca kapanır
        >
