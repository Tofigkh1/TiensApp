          ...
          >
            ...
            >
              <VStack align="start" mt={2}>
                <Tag 
                 style={{ transition: 'background-color 0.3s ease' }}  // Geçiş efekti için
                 _hover={{ bg: 'green.500' }} // Hover durumunda arka plan rengini yeşil yapın
                colorScheme="teal">
                  <li onClick={() => { handleCategory(null); onClose(); }}>
                  <p className="font-bold text-xl capitalize cursor-pointer hover:text-green-500">
  all categories
</p>
                  </li>
                </Tag>
